...
$(document).ready(function () { 
  if ( $(window).width() > 768) {      
	...
	$('#sticky-mobile').width($('#sticky-mobile').parent().width());
	}
});
...
$(window).on("scroll", function() {
	var position = $("#pay").offset();
	var position2 = $("#giftcards").offset();
	...
	if ($(window).scrollTop() > position2.top - 100) { 
		// activate your class.
		$(".nav1").removeClass("current");
	} else {
		// otherwise remove it.
...
// Activates when you scroll.
$(window).on("scroll", function() {
	var position = $("#giftcards").offset();
	var position2 = $("#lgpayperks").offset();
...
// Activates when you scroll.
$(window).on("scroll", function() {
	var position = $("#lgpayperks").offset();
	var position2 = $("#getstarted").offset();
...
// Activates when you scroll.
$(window).on("scroll", function() {
	var position = $("#getstarted").offset();
